...
const base_body_data = {
	"male": {
		...
		"BMI": { 0: { "avg": 17.1, "sd": 0.3 }, 1: { "avg": 17.1, "sd": 0.3 }, 2: { "avg": 16.6, "sd": 0.9 }, 3: { "avg": 15.0, "sd": 0.2 }, 4: { "avg": 15.5, "sd": 0.3 }, 5: { "avg": 15.6, "sd": 0.4 }, 6: { "avg": 15.6, "sd": 0.6 }, 7: { "avg": 17.2, "sd": 0.5 }, 8: { "avg": 17.0, "sd": 0.6 }, 9: { "avg": 18.8, "sd": 0.5 }, 10: { "avg": 19.6, "sd": 1.0 }, 11: { "avg": 19.9, "sd": 0.6 }, 12: { "avg": 20.9, "sd": 0.8 }, 13: { "avg": 20.3, "sd": 0.5 }, 14: { "avg": 20.1, "sd": 0.4 }, 15: { "avg": 21.4, "sd": 0.6 }, 16: { "avg": 20.0, "sd": 0.4 }, 17: { "avg": 22.2, "sd": 1.2 }, 18: { "avg": 22.2, "sd": 1.0 }, 19: { "avg": 24.5, "sd": 0.3 }, 45: { "avg": 25.0, "sd": 0.2 }, 65: { "avg": 24.8, "sd": 0.2 }, },
	},
	"female": {
		...
		"BMI": { 0: { "avg": 15.2, "sd": 0.4 }, 1: { "avg": 16.8, "sd": 0.4 }, 2: { "avg": 15.8, "sd": 0.2 }, 3: { "avg": 15.5, "sd": 0.2 }, 4: { "avg": 15.7, "sd": 0.6 }, 5: { "avg": 15.4, "sd": 0.3 }, 6: { "avg": 15.1, "sd": 0.3 }, 7: { "avg": 16.1, "sd": 0.3 }, 8: { "avg": 17.2, "sd": 0.4 }, 9: { "avg": 16.3, "sd": 0.4 }, 10: { "avg": 17.7, "sd": 0.5 }, 11: { "avg": 19.6, "sd": 0.6 }, 12: { "avg": 21.3, "sd": 0.9 }, 13: { "avg": 21.3, "sd": 0.6 }, 14: { "avg": 19.8, "sd": 0.3 }, 15: { "avg": 20.3, "sd": 0.4 }, 16: { "avg": 20.9, "sd": 0.5 }, 17: { "avg": 22.1, "sd": 0.4 }, 18: { "avg": 24.2, "sd": 1.5 }, 19: { "avg": 23.0, "sd": 0.3 }, 45: { "avg": 24.0, "sd": 0.2 }, 65: { "avg": 24.7, "sd": 0.2 }, },
	},
}
...
module.exports = {
	...
	getBaseBodyData: function (item, gender, age) {
		let data_list = util.getKeyFromList(base_body_data[gender][item], age);	// 如果沒有符合年齡的資料，則從下往上尋找最相近的資料
		let random_value = util.getDataBySD(data_list.avg * 1, data_list.sd * 1);

		return random_value;
	},

	getBaseBodyDataByBMI: function (item, gender, age, another_value) {
		let data_list = util.getKeyFromList(base_body_data[gender]["BMI"], age);	// 如果沒有符合年齡的資料，則從下往上尋找最相近的資料
		let bmi = util.getDataBySD(data_list.avg * 1, data_list.sd * 1);

		if (item == "height") {
			return Math.sqrt(another_value / bmi) * 100;
		} else if (item == "weight") {
			return Math.pow(another_value / 100, 2) * bmi;
		}
	},
